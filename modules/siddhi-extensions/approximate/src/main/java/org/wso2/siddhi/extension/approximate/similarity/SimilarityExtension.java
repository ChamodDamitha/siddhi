...
import org.wso2.siddhi.extension.approximate.cardinality.HyperLogLog;
...
public class SimilarityExtension extends StreamProcessor {
    ...
    protected void process(ComplexEventChunk<StreamEvent> streamEventChunk, Processor nextProcessor,
        ...
        while (streamEventChunk.hasNext()) {
            ...
            Object newData1 = attributeExpressionExecutors[0].execute(complexEvent);
            Object newData2 = attributeExpressionExecutors[1].execute(complexEvent);
            minHash.addProperty(newData1, newData2);
...
//      Additional attribute declaration
        ...
        attributes.add(new Attribute("similarity", Attribute.Type.DOUBLE));
